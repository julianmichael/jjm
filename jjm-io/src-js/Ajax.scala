...
/** Thrown when `Ajax.get` or `Ajax.post` receives a non-20X response code. Contains the XMLHttpRequest that resulted in
  * that response. Unabashedly copied from an old version of scalajs-dom.
  * See https://github.com/scala-js/scala-js-dom/blob/44ff6b1/dom/src/main/scala/org/scalajs/dom/ext/AjaxException.scala
  */
...
/** Wraps an XMLHttpRequest to provide an easy one-line way of making an Ajax call, returning a Future.
  * Unabashedly copied from an old version of scalajs-dom.
  * See https://github.com/scala-js/scala-js-dom/blob/44ff6b1/dom/src/main/scala/org/scalajs/dom/ext/Ajax.scala
  */
object Ajax {
